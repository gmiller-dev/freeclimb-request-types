// Request Utils
export function isInboundRequest(requestBody: any): requestBody is InboundCallRequestBody {
 ...
 * A PerCL response is expected.
 */
export  interface GetDigitsRequestBody {
 ...
 * A PerCL response is expected.
 */
export  interface OutDialApiConnect {
    /**
     * Context or reason why this request is being made.
