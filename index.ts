// Request Utils
export function isAddToConferenceNotification(requestBody: any) : requestBody is AddToConferenceNotificationBody {
  return requestBody?.requestType === "addToConferenceNotification";
}

export function isAddToQueueNotification(requestBody: any): requestBody is AddToQueueNotifcationBody {
    return requestBody?.requestType === "addToQueueNotification";
}

export function isCallControl(requestBody: any): requestBody is CallControlBody {
    return requestBody?.requestType === "callControl";
}

export function isCallStatus(requestBody: any): requestBody is CallStatusBody {
    return requestBody?.requestType === "callStatus";
}

export function isConferenceRecordingStatus(requestBody: any): requestBody is ConferenceRecordingStatusBody {
    return requestBody?.requestType === "conferenceRecordingStatus";
}

export function isConferenceStatus(requestBody: any): requestBody is ConferenceStatusBody {
    return requestBody?.requestType === "conferenceStatus";
}

export function isCreateConference(requestBody: any): requestBody is CreateConferenceBody {
    return requestBody?.requestType === "createConference";
}

export function isDequeue(requestBody: any): requestBody is DequeueBody {
    return requestBody?.requestType === "dequeue";
}

export function isGetDigits(requestBody: any): requestBody is GetDigitsBody {
    return requestBody?.requestType === "getDigits";
}

export function isGetSpeech(requestBody: any): requestBody is GetSpeechBody {
    return requestBody?.requestType === "getSpeech";
}

export function isInboundCall(requestBody: any): requestBody is InboundCallBody {
    return requestBody?.requestType === "inboundCall";
}

export function isLeaveConference(requestBody: any): requestBody is LeaveConferenceBody {
    return requestBody?.requestType === "leaveConference";
}

export function isMachineDetected(requestBody: any): requestBody is MachineDetectedBody {
    return requestBody?.requestType === "machineDetected";
}

export function isMessageDelivery(requestBody: any): requestBody is MessageDeliveryBody {
    return requestBody?.requestType === "messageDelivery";
}

export function isMessageStatus(requestBody: any): requestBody is MessageStatusBody {
    return requestBody?.requestType === "messageStatus";
}

export function isOutDialApiConnect(requestBody: any): requestBody is OutDialApiConnectBody{
    return requestBody?.requestType === "outDialApiConnect";
}

export function isOutDialConnect(requestBody: any): requestBody is OutDialConnectBody {
    return requestBody?.requestType === "outDialConnect";
}

export function isOutDialStart(requestBody: any): requestBody is OutDialStartBody {
    return requestBody?.requestType === "outDialStart";
}

export function isQueueWait(requestBody: any): requestBody is QueueWaitBody {
    return requestBody?.requestType === "queueWait";
}

export function isRecord(requestBody: any): requestBody is RecordBody {
    return requestBody?.requestType === "record";
}

export function isRedirect(requestBody: any): requestBody is RedirectBody {
    return requestBody?.requestType === "redirect";
}

export function isRemoveFromQueueNotification(requestBody: any): requestBody is RemoveFromQueueNotificationBody {
    return requestBody?.requestType === "removeFromQueueNotification";
}

//Types
export type FcRequestBody = AddToConferenceNotificationBody
...
export function isFCRequestBody(requestBody: any): requestBody is FcRequestBody {
    return (requestBody as FcRequestBody)?.requestType !== undefined
     && typeof (requestBody as FcRequestBody)?.requestType === "string";
}
