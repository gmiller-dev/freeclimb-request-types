declare interface FCApiRequest<T> {
    body: T
  }
...
declare interface AddToConferenceNotificationBody {
...
declare interface AddToQueueNotifcationBody {
...
declare interface CallControlBody {
...
declare interface CallStatusBody {
...
declare interface ConferenceRecordingStatusBody {
...
declare interface ConferenceStatusBody {
...
declare interface CreateConferenceBody {
 ...
 * A PerCL response is expected.
 */
declare interface GetDigitsRequestBody {
 ...
 * A PerCL response is expected.
 */
declare interface getSpeechBody {
 ...
 */
declare interface InboundCallRequestBody {
    /**
 ...
 */
declare interface LeaveConferenceBody {
    /**
     * Context or reason why this request is being made.
 ...
 * A PerCL response is expected.
 */
declare interface MachineDetectedBody {
    /**
     * Context or reason why this request is being made.
 ...
 */
declare interface MessageDeliveryBody {
    /**
 ...
 */
declare interface MessageStatusBody {
    /**
 ...
 * A PerCL response is expected.
 */
declare interface OutDialApiConnect {
    /**
     * Context or reason why this request is being made.
 ...
 * A PerCL response is expected.
 */
declare interface OutDialConnectBody {
    /**
     * Context or reason why this request is being made.
 ...
 * A PerCL response is expected.
 */
declare interface OutDialStartBody {
    /**
     * Context or reason why this request is being made.
 ...
 *  Hangup
 */
declare interface QueueWaitBody {
    /**
     * Context or reason why this request is being made.
 ...
 * A PerCL response is expected.
 */
declare interface RedirectBody {
    /**
     * Context or reason why this request is being made.
 ...
 */
declare interface RemoveFromQueueNotificationBody {
